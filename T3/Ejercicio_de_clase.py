...
r_prime_t0 = np.array([0, 1, 2])  # Derivada en t = 1
magnitude_r_prime_t0 = np.sqrt(0**2 + 1**2 + 2**2)
unit_tangent = r_prime_t0 / magnitude_r_prime_t0

# Ecuación de la línea tangente: r(t) + t * T(t)
t_line_values = np.linspace(-20.0, 20.0, num=101)  # Ajustado para estar cerca de t = 1
