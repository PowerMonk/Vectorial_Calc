...
#Curva paramétrica
t = np.linspace(-2.0, 4.0, num=61) #linspace  no tiene el problema de redondeo que presenta arange
xc = np.power(t, 2) - 2 * t
yc = t + 1
...
#Punto conocido
t0 = -1
x0 = np.power(t0, 2) - 2 * t0
y0 = t0 + 1
myAxis.scatter(x0, y0, c = 'blue', s = 15)


#Línea tangente
x_line_values = np.linspace(-10.0, 10.0, num=61)
